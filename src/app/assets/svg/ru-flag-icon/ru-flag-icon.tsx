export const RuFlag = (
  <svg fill={'none'} height={'24'} width={'24'} xmlns={'http://www.w3.org/2000/svg'}>
    <path d={'M0 0h24v24H0z'} fill={'url(#ru_svg__a)'}></path>
    <defs>
      <pattern height={'1'} id={'ru_svg__a'} patternContentUnits={'objectBoundingBox'} width={'1'}>
        <use transform={'scale(.01389)'} xlinkHref={'#ru_svg__b'}></use>
      </pattern>
      <image
        height={'72'}
        id={'ru_svg__b'}
